package com.adobe.wheelerstreet.fig.panzoom.commands
{
	...
	public class ZoomCommand extends EventDispatcher implements ICommand {
		...
		public function execute():void {		
			...
			_animateProperty.addEventListener(TweenEvent.TWEEN_END, handleTweenEnd);
		...
		private function handleTweenEnd(e:TweenEvent):void {
			_client.dispatchEvent(new PanZoomEvent(PanZoomEvent.IMAGE_RESIZED));
		}
	}
}