...
urlpatterns = patterns('',
    url(r'^search/(?P<id>\d+)/(?P<name>[-\w]+)/$', search, name='shared-search'),
    url(r'^image/(?P<id>\d+)/(?P<name>[-\w]+)/$', proxy_image, name='shared-proxy-image'),
    url(r'^select/(?P<id>\d+)/(?P<name>[-\w]+)/$', select, name='shared-select'),
