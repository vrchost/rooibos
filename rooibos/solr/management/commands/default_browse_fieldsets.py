...
"""
    ...
    def handle(self, *args, **kwargs):
        ...
        fieldset, created = self.get_or_create_fieldset('facet-fields', _get_facet_fields())
        if created:
        ...
        for collection in Collection.objects.filter(owner=None):
            ...
            fieldset, created = self.get_or_create_fieldset(name, _get_browse_fields(collection.id))
            if created:
